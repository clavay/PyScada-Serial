...
from pyscada.serial.models import SerialDevice, SerialVariable, SerialDeviceHandler, ExtendedSerialVariable, \
...
@receiver(post_save, sender=SerialDeviceHandler)
...
def _reinit_daq_daemons(sender, instance, **kwargs):
    ...
    elif type(instance) is SerialDeviceHandler:
        # todo
        pass
